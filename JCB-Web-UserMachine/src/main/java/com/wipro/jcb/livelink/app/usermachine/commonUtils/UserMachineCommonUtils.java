package com.wipro.jcb.livelink.app.usermachine.commonUtils;
...
public class UserMachineCommonUtils {
	...
	public static UserDetails getUserDetails(String userDetails) {
		...
		String roleName = UserMachineCommonUtils.getRolesByID(roleId);
