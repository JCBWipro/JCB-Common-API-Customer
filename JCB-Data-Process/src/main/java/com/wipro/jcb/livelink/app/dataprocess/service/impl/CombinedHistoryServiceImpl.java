package com.wipro.jcb.livelink.app.dataprocess.service.impl;
...
@Slf4j
@Repository
public class CombinedHistoryServiceImpl implements CombinedHistoryService {
    ...
    public void addBatchMachineWithEngineStatus(List<MachineEngineStatus> packets) {
        try {
            ...
            log.error("Failed to add engine status with message ", ex);
        }
    }

    @Override
    public List<Map<String, Object>> getMachineForTimefenceAlert(Set<String> vinList, String today) {
        return List.of();
    }
    ...
    public List<Map<String, Object>> getMachineForTimefenceAlert(Set<String> vinList) {
        ...
        try {
            ...
            log.debug("query  executed getMachineForTimefenceAlert records count is {} ", machineInfo.size());
        } catch (Exception ex) {
            log.error("Failed to get getMachineForTimefenceAlert with message ", ex);
        }
        return machineInfo;
    }
    ...
    public List<Map<String, Object>> getMachineForGeofenceAlert(Set<String> vinList) {
        ...
        try {
            ...
            log.debug("query executed getMachineForGeofenceAlert records count is {}", machineInfo.size());
        } catch (Exception ex) {
            log.error("Failed to get getMachineForGeofenceAlert with message", ex);
        }
        return machineInfo;
    }
    ...
    public void addTimefenceAlert(List<AlertData> alertData) {
        try {
            ...
            log.warn("Failed to update Timefence Alert with message ", ex);
        }
    }
    ...
    public void addGeofenceAlert(List<AlertData> alertData) {
        try {
            ...
            log.warn("Failed to update GeofenceAlert with message ", ex);
        }
    }
    ...
    public int findByAlertById(String id) {
        ...
        try {
            ...
            log.error("Failed to get alert id in findByAlertById with message", ex);
        }
        return count;
    }

    @Override
    public List<Map<String, Object>> findAlertByVin(Set<String> vinList) {
        return List.of();
    }
    ...
    public int removeAlertForGeofence(Set<String> vinList) {
        ...
        try {
            ...
            log.error("Failed during removeAlertForGeofence excution with message ", ex);
        }
        return rows;
    }
    ...
    @Override
    public void updateStatusOnTime(List<MachineData> packets, Timestamp lastModifiedDate) {
        ...
        try {
            ...
            jdbcTemplate.batchUpdate(MACHINE_LOCATION, new BatchPreparedStatementSetter() {
                ...
                public void setValues(PreparedStatement ps, int i) throws SQLException {
                    ...
                    ps.setTimestamp(1, packet.getStatusAsOn());
                    ...
                    ps.setTimestamp(6, packet.getStatusAsOn());
            ...
            log.error("Failed to update updateBatchMachineWithoutFuel with message ", ex);
        }
    }
    ...
    public void updateBatchMachineFeedDataHavingFuel(List<MachineData> packets) {
        ...
        try {
            ...
            log.error("Failed to update updateBatchMachineWithFuel with message ", ex);
        }
    }
    ...
    public void addBatchMachineLocationHistory(List<MachineLocationHistory> machineLocationHistory) {
        try {
            ...
            log.error("Failed to add fuel machine location history with message ", ex);
        }
    }
        ...
        try {
            ...
            jdbcTemplate.batchUpdate(MACHINE_LOCATION_HISTORY_UPDATE, new BatchPreparedStatementSetter() {
                ...
                public void setValues(PreparedStatement ps, int i) throws SQLException {
                    ...
                    ps.setTimestamp(1, packet.getNewStatusAsOn());
                    ps.setString(2, packet.getVin());
                    ps.setDouble(3, packet.getLatitude());
                    ps.setDouble(4, packet.getLongitude());
                    ps.setTimestamp(5, packet.getOldStatusAsOn());
            ...
            log.error("Failed to add fuel machine location history with message ", e.getMessage());
            e.printStackTrace();
        ...
        try {
            ...
            jdbcTemplate.batchUpdate(MACHINE_LOCATION_HISTORY, new BatchPreparedStatementSetter() {
                ...
                public void setValues(PreparedStatement ps, int i) throws SQLException {
                    ...
                    ps.setTimestamp(3, locationDetails.getStatusAsOn());
