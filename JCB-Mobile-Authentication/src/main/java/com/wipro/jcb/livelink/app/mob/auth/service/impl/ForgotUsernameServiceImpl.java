...
public class ForgotUsernameServiceImpl extends ForgotUsernameService {
    ...
    public MsgResponseTemplate forgotUsername(String mobileNumber, String emailId) {
        try {
            String username;
            String firstName = userRepository.findFirstNameFromID(emailId);
            if (mobileNumber != null && !mobileNumber.trim().isEmpty()) {
                username = userRepository.findByMobileNumber(mobileNumber);
                if (username == null) {
                ...
                username = userRepository.findByEmailId(emailId);
                if (username == null) {
