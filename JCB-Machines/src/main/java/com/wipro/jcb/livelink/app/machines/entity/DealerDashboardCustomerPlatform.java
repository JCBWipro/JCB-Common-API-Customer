...
@NoArgsConstructor
@XmlRootElement
@Table(name = "DealerDashboardCustomerPlatform", indexes = { @Index(name = "DealerDashboardCustomerPlatform", columnList = "customer_id,platform_name", unique = false) })
@DynamicUpdate
public class DealerDashboardCustomerPlatform implements Serializable {
    ...
    @Column(name = "DealerDashboardCustomerPlatform_Id", unique = true, nullable = false)
    private Long id;
