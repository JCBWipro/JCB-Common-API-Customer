			...
			if (userName != null) {
				...
				if (null != gfSetRequest.getVin() && null != gfSetRequest.getCenterLatitude()
					...
					log.info(
							...
							gfSetRequest.getCenterLatitude(), gfSetRequest.getCenterLongitude(),
		...
		try {
			...
			if (userName != null) {
				...
				if (null != tfSetRequest.getVin() && null != tfSetRequest.getStartTime()
					...
					log.info("Timefence parameters StartTime:{} and EndTime:{} Updated Successfully", tfSetRequest.getStartTime(), tfSetRequest.getEndTime());
					return new ResponseEntity<ResponseData>(
